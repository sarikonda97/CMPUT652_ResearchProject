...
for coCreativity in coCreativities:
    ...
    print("The mean of the densities for " + "co-creativity type " + coCreativity + " is: " + str(std.mean(densities)) )
    print("\nThe SD of the densities for " + "co-creativity type " + coCreativity + " is: " + str(std.stdev(densities)))
    print("\n")
    print("-----------------------------------------------------")
